...
#define KAI_THROW_1(E, A0) throw KAI_NAMESPACE(exception::E)(KAI_FILE_LOCATION, A0)

#define KAI_THROW_2(E, A0, A1) throw KAI_NAMESPACE(exception::E)(KAI_FILE_LOCATION, A0, A1)

#define KAI_THROW_3(E, A0, A1, A2) \
    throw KAI_NAMESPACE(exception::E)(KAI_FILE_LOCATION, A0, A1, A2)

#define KAI_NOT_IMPLEMENTED() throw KAI_NAMESPACE(exception::NotImplemented)(KAI_FILE_LOCATION);
